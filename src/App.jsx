...
export default function App() {
  ...
  const [appointments, setAppointments] = useLocalStorageState('beauty_studio_demo_appointments', SEED_APPOINTMENTS)
  const [professionals, setProfessionals] = useLocalStorageState('beauty_studio_demo_professionals', SEED_PROFESSIONALS)
  const [blockedDates, setBlockedDates] = useLocalStorageState('beauty_studio_demo_blocked_dates', [])
